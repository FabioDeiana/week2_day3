...
console.log("charactersNames", characters)
...
for (let character of starWarsCharacters) {
  let color = character.eye_color
  if (eyeColor.hasOwnProperty(color)) {
    eyeColor[color].push(character.name)
  }
}
...
console.log(
  starWarsCharacters.filter((character) => character.gender === "robot")
)
